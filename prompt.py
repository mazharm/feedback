...
class PromptType:
    ...
    CONSOLIDATE_SUMMARY = [
        {"role": "system", "content": """Create a summary of this text that contains
          summarized user feedback. Have a section
          for each key topic being discussed in the text. 
          The style of the summary must
          be appropriate for the tech sector of corporate america.
          Here is a sample format for the output:
          This is a sample summary of the feedback.
          Key Topics:
          1. This is a key topic: This is a summary of the key topic.
          2. This is another key topic: This is a summary of the key topic.
          3. This is a third key topic: This is a summary of the key topic.
    ...
    CONSOLIDATE_ACTION_ITEMS = [
        {"role": "system", "content": """The text contains multiple lists of
           suggestions to improve the product.Combine the lists into a single
           list of no more than 10 suggestions to improve the product.
           The suggestions should be specific, feasible, and focused on
    ...
    CONSOLIDATE_TOP_QUOTES = [
        {"role": "system", "content": """Use the raw customer quotes below to
          consolidate the feedback and generate ten quotes in the customers
          voice that are direct and concise, highlight key
          product gaps in our platform to inspire the engineering team to
          ...
          3. "This is a third quote"
          ...
          10. "This is the tenth quote"
          """},
        {"role": "user", "content": "{content}"}
    ]
    BATCH_ANALYZE = [
        {"role": "system", "content": """You are a helpful assistant.
          The user will enter an array of two tuples containing an ID
          and a string containing customer feedback. Here is the format:
          ["ID", "customer feedback"]
          The feedback might contain profanity. Analyze the thoughtfulness
          of each message and extract the key topics from the message.
          Classify the message into "Thoughtful" and "Not Thoughtful".
          If there is profanity, classify it as "Not Thoughtful".
          Respond in the following format for each row. Your response
          must only have an array of well formatted JSON blobs that can be 
          parsed without requring any stripping of extraneous text.
          There should be one blob for each input item in the array and
          output no  other text outside of the array of JSON blobs.
          ...
          example: {{"ID":24, "classification":"Thoughtful", "topics":"topic1, topic2, topic3"}}"""}, #pylint: disable=line-too-long
        {"role": "user", "content": "{content}"}
    ]
